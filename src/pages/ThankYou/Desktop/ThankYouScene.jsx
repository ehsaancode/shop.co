...
<>
         <QSection
          widgetId="1764422925044608"
          bgColor="rgba(4, 0, 0, 1.00)"
          tailwaindClasses="w-full h-screen relative flex flex-row justify-center items-center"
        >
            <QFlex
             widgetId="1764422984076468"
           ...
           >
              ...
              />
               <QTextH2
                widgetId="1764422984080329"
                headerText="Thank you"
                tailwaindClasses="w-[auto] h-auto pt-[20px] static font-[Arial] text-6xl font-bold text-[#191718FF] text-left"
              />
               <QTextH2
                widgetId="1764422984083842"
                headerText="Your purchase confirmed."
                tailwaindClasses="w-[auto] h-auto pb-[10px] static font-[Arial] text-xl font-bold text-[#000000FF] text-left"
              />
               <QParagraph
                widgetId="1764422984078422"
                headerText="Your order has been successfully placed and is being processed. You&apos;ll receive a confirmation email shortly with your order details and tracking information."
